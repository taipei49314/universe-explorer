...
TOPIC_ZH = {
    ...
    "polar": {
        "title": "南北極",
        "summary": ("北極與南極的容器 topic,本身沒有燈號。形狀:🟢 冰芯古氣候檔案;"
                    "🔵 北極海冰多十年衰退與格陵蘭質量損失;🟡 南極全洲質量收支"
                    "如何分配;🟠 MISI/Thwaites、凍土碳回饋、南極海冰極端;"
                    "🔴 把「幾年內幾乎必然無夏冰」說成已結案的過度確定。"),
    },
    "exoplanets": {
        "title": "系外行星",
...
CLAIMS = {
    ...
    "induced_seismicity_human_activities": {
        "title": "人類活動(尤其是流體注入)可誘發地震",
        "reasons": {
            "mainstream_model_support":
                "流體注入誘發地震是標準應用地震學。",
            "minor_alternatives_exist":
                "部分事件在誘發與天然之間仍模糊;注入誘發地震這一類別本身無疑。",
            "overall_direction_robust":
                "更多盆地與機制(地熱、壓裂、水庫蓄水)持續確認此現象。",
        },
        "evidence": [
            "高速率廢水注入與地震率上升的時空相關,在充分研究區域建立因果連結。",
            "美國中部的細緻研究把特定注入井與體積連到升高的地震活動,包括致災事件。",
        ],
        "open_questions": [
            "什麼孔隙壓力門檻最能預測誘發序列?",
            "監管應如何在能源作業與地震風險間取捨?",
    ...
    "short_term_deterministic_prediction": {
        "title": "確定性短臨地震預測在當前科學下可達成,還是本質上只能做機率預報",
        "reasons": {
            "two_or_more_mainstream_models":
                "僅預報的正統與持續的預測研究綱領都出現在同行評審文獻。",
            "no_decisive_evidence_yet":
                "尚未證明任何有共識的作業性短臨預測器。",
            "genuine_scientific_camps":
                "預測 vs 預報分裂是數十年辯論,不是修辭發明。",
        },
        "evidence": [
            "長期主流評估認為:可靠的大地震確定性短臨預測不被斷層系統的物理或統計支持。",
            "作業地震預報框架改以時變機率服務民防,並明確區別於確定性預測。",
        ],
        "competing": [
            {"name": "預測不可達成(僅能預報)",
             "for": "混沌載入、前兆可重現性有限與前瞻測試失敗支持僅能機率預報。",
             "against": "仍有研究者追求多參數前兆系統以做短臨警報。",
             "limits": "公眾對「何時」訊息的需求把機構推超出物理所能交付。"},
            {"name": "有用的短臨預測仍可能出現",
             "for": "更密台網、AI 型樣搜尋與多感測前兆被主張重開問題。",
             "against": "對大地震仍缺乏有作業技巧的前瞻、預先登記成功。",
             "limits": "事後挑選與發表偏差是慢性問題。"},
        ],
        "open_questions": [
            "任何前兆宣稱能否通過前瞻、預先登記測試?",
            "機構如何在不暗示假預測技巧下溝通預報機率?",
        ],
    },
    "slow_slip_and_ets_observed": {
        "title": "部分隱沒帶觀測到慢滑移事件與陣發性微震與滑移(ETS)",
        "reasons": {
            "new_discovery":
                "慢滑移與 ETS 是本世紀確立的觀測事實。",
            "rapidly_growing_literature":
                "全球慢地震目錄持續擴張。",
            "no_consensus_formed_yet":
                "與巨大地震時機的連結仍是開放研究綱領。",
        ...
        "evidence": [
            "Cascadia 的大地測量與地震紀錄記載伴隨微震的重複慢滑移(ETS)。",
            "日本西南發現的深層非火山微震開啟了慢變形現象的觀測類別。",
        ],
        "open_questions": [
            "慢滑移週期如何關係到巨大隱沒帶地震的時機?",
            "什麼物理條件選擇慢破裂 vs 快破裂?",
        ],
    },
    # ---- black hole -------------------------------------------------------
    ...
    "kerr_describes_astrophysical_bh": {
        "title": "天體黑洞由克爾度規(質量與自旋)良好描述",
        "reasons": {
            "mainstream_model_support":
                "克爾作為天體黑洞時空是重力波資料分析與 EHT 建模的預設。",
            "minor_alternatives_exist":
                "參數化非克爾度規與奇異緻密天體仍是活躍少數綱領。",
            "overall_direction_robust":
                "每次新的鈴宕與視界尺度影像在誤差內都與克爾一致,是收緊界限而非取代框架。",
        },
        "evidence": [
            "GW150914 的鈴宕與旋近–併合一致性檢驗在首次偵測精度內符合克爾殘骸,"
            "未見大幅偏離廣義相對論的證據。",
            "M87* 環直徑在標準發射假設下符合動力學質量估計的克爾黑洞光子軌道／陰影尺度。",
        ],
        "open_questions": [
            "下一代重力波偵測器與多頻 EHT 能多緊地約束高階多極與非克爾度規?",
            "吸積流系統誤差是否仍允許當前解析度下的輕微無視界模仿者?",
        ],
    },
    "smbh_common_in_galaxy_nuclei": {
        "title": "超大質量黑洞普遍寄居在大質量星系的核球",
        "reasons": {
            "mainstream_model_support":
                "大質量星系中心 SMBH 是標準河外天文學。",
            "minor_alternatives_exist":
                "部分核可能以核星團為主而無主導黑洞;那是佔有率的 refinement,"
                "不是否定大質量系統中的 SMBH。",
            "overall_direction_robust":
                "動力學樣本、AGN 人口與 EHT 目標持續強化核 SMBH 典範。",
        },
        "evidence": [
            "數十年恆星與氣體動力學測量在近鄰大質量星系中找到數百萬至數十億太陽質量的"
            "中心暗質量,並與核球性質相關。",
            "Sgr A* 的視界尺度成像確認銀河中心暗質量符合約四百萬太陽質量黑洞,"
            "錨定 SMBH 圖像的本地校準。",
        ],
        "open_questions": [
            "第一批種子如何形成並在 z~7 長到十億太陽質量類星體?",
            "低質量與矮星系中的佔有率為何?",
        ],
    },
    "lower_mass_gap_compact_objects": {
        "title": "最重中子星與最輕恆星黑洞之間的低質量間隙是真實物理還是選擇效應",
        "reasons": {
            "two_or_more_mainstream_models":
                "物理間隙與選擇效應陣營都在重力波與 X 射線雙星文獻中活躍發表。",
            "no_decisive_evidence_yet":
                "邊界質量事件與仍有限的樣本使間隙真實性未底定。",
            "genuine_scientific_camps":
                "綜述與目錄論文明確記錄分裂。",
        },
        "evidence": [
            "GW190814 的次星質量約 2.6 太陽質量,高於典型中子星上限、低於許多恆星黑洞質量,"
            "把間隙問題推入多信使視野。",
            "重力波目錄與 X 射線雙星的族群分析辯論約 2–5 太陽質量區是因物理"
            "(爆炸引擎／對物理)人口稀少,還是偵測與分類偏差。",
        ],
        "competing": [
            {"name": "物理低質量間隙",
             "for": "核心塌縮引擎與回落模型可抑制最大中子星質量之上窗口內的殘骸。",
             "against": "如 GW190814 等事件可能填滿或模糊窗口;邊緣依賴不確定的 NS 物態方程與爆炸物理。",
             "limits": "NS–BH 邊界小樣本統計。"},
            {"name": "選擇／分類連續體",
             "for": "偵測門檻、電磁後續偏差與質量–自旋簡併可模仿間隙。",
             "against": "部分 X 射線雙星樣本在偏差討論後仍顯稀少。",
             "limits": "異質的電磁與重力波選擇函數。"},
        ],
        "open_questions": [
            "GW190814 的次星是重中子星、輕黑洞,還是別的?",
            "更大的重力波樣本會否平滑填滿 2–5 太陽質量?",
        ],
    },
    "jets_extract_bh_spin": {
        "title": "強大河外噴流由抽取黑洞自轉能驅動(Blandford–Znajek 類過程)",
        "reasons": {
            "rapidly_growing_literature":
                "GRMHD 噴流發射模擬與 EHT 偏振構成快速綱領。",
            "no_consensus_formed_yet":
                "自旋抽取是領先框架;盤風功率對許多源仍是活替代或共通道。",
            "insufficient_observation":
                "直接、乾淨的自旋–噴流效率測量仍稀少。",
        },
        "evidence": [
            "Blandford–Znajek 機制顯示貫穿旋轉克爾洞的有序磁場可抽取自轉能,"
            "形成以坡印廷通量為主的外流。",
            "M87* 的 EHT 偏振影像揭示近視界磁化流的組織方式,"
            "與常搭配自旋抽取的磁阻塞盤／噴流發射模型一致。",
        ],
        "open_questions": [
            "噴流功率有多少來自黑洞自旋、多少來自吸積盤(Blandford–Payne)?",
            "X 射線反射與噴流功率的自旋測量能否逐天體調和?",
        ],
    },
    "horizonless_gw_echoes": {
        "title": "來自反射性無視界表面的重力波回聲已被觀測確立",
        "reasons": {
            "not_accepted_by_mainstream":
                "領域不接受重力波回聲為已確立的偵測。",
            "no_observational_evidence":
                "沒有社群接受的觀測證據確立回聲;聲稱訊號在發現顯著度上仍受爭議或未再現。",
        },
        "evidence": [
            "部分無視界超緻密天體模型預測:若準視界被部分反射面取代,"
            "主鈴宕後會出現延遲重複脈衝(回聲)。",
            "LIGO–Virgo 對併合鈴宕的分析在已發表檢驗內符合標準克爾阻尼;"
            "社群不把回聲偵測視為已確立。",
        ],
        "open_questions": [
            "未來偵測器能否給出決定性上限,關閉流行的回聲參數空間?",
            "已報告的低顯著度回聲候選在盲分析下可否再現?",
        ],
    },
    # ---- ocean ------------------------------------------------------------
    ...
    "ocean_acidification_anthropogenic": {
        "title": "人為 CO2 吸收正在酸化表層海洋",
        "reasons": {
            "mainstream_model_support":
                "人為海洋酸化是標準海洋化學與 IPCC 評估內容。",
            "minor_alternatives_exist":
                "自然變率在區域上調制訊號;並不取代長期趨勢的人為驅動。",
            "overall_direction_robust":
                "更長紀錄與更密觀測網強化了趨勢偵測。",
        },
        "evidence": [
            "表層海洋 pH 與碳酸鹽化學時間序列顯示 pH 下降,與大氣 CO2 上升並行。",
            "全球評估把數十年酸化趨勢主要歸因於海洋對人為碳的吸收。",
        ],
        "open_questions": [
            "區域上升流與生物如何調制沿岸酸化極端?",
            "跨類群的生物與生態系門檻為何?",
    ...
    "microplastics_reach_deep_ocean": {
        ...
        "evidence": [
            "沉積物岩芯與深海樣品含遠低於透光層的微塑膠纖維與碎片。",
            "超深淵海溝樣品顯示部分最深海洋環境中的塑膠碎片與微塑膠。",
        ],
        "open_questions": [
            "表層塑膠產量有多少比例到達深淵?",
            "深海食物網如何與微塑膠負荷互動?",
    ...
    "deep_sea_mining_impacts_uncertain": {
        "title": "商業深海採礦將造成巨大且長久的生態影響,目前尚無法完全量化",
        "reasons": {
            "rapidly_growing_literature":
                "採礦影響與基線生物多樣性論文在可能商業啟動前快速擴張。",
            "insufficient_observation":
                "沒有完整商業規模採礦時間序列可校準長期復原。",
            "no_consensus_formed_yet":
                "政策與科學仍在協商真實作業下影響有多大、多久。",
        },
        "evidence": [
            "試驗採礦與類似擾動的綜述記錄沉積羽流、棲地移除與深淵群落緩慢復原。",
            "CCZ 基線工作顯示高比例未描述生物多樣性,並主張商業開採前影響模型仍資料不足。",
        ],
        "open_questions": [
            "羽流與噪音足跡如何縮放到商業作業?",
            "保護區設計能否抵銷結核場損失?",
    ...
    "ice_cores_record_paleoclimate": {
        "title": "極地冰芯保存過去氣候與大氣成分的多代理記錄",
        "reasons": {
            "multiple_independent_replications":
                "Vostok、EPICA Dome C 等獨立深冰芯重建出一致的冰期–間冰期同位素與氣體型式。",
            "accepted_in_mainstream_textbooks":
                "冰芯古氣候是氣候與第四紀教科書的標準內容。",
            "no_mainstream_competing_theory":
                "主流不否認極地冰保存分層氣候與氣體紀錄;爭論在詮釋細節。",
            "no_recent_major_refutation":
                "後續冰芯與再分析是精煉,而非推翻冰芯檔案。",
        },
        "evidence": [
            "EPICA Dome C 冰芯同位素與氣體紀錄重建南極氣候與大氣 CO2 達八個冰期循環,"
            "測量來自冰本身。",
            "Vostok 冰芯在另一個東南極地點獨立取得多循環溫度代理與溫室氣體紀錄。",
        ],
        "open_questions": [
            "連續南極冰芯能否推到超過約 80 萬年?",
            "格陵蘭與南極冰芯之間的兩極蹺蹺板時序如何最佳對齊?",
        ],
    },
    "arctic_sea_ice_multidecade_decline": {
        "title": "北極海冰範圍在衛星時代呈多十年衰退",
        "reasons": {
            "mainstream_model_support":
                "衛星紀錄與氣候評估綜述把北極海冰多十年衰退視為主流氣候科學的穩健觀測事實。",
            "minor_alternatives_exist":
                "自然變率與再分析細節的少數討論精煉歸因與年際噪聲,並不否定多十年衰退本身。",
            "overall_direction_robust":
                "衛星時代長期方向跨產品穩健;新證據多在修正速率與極端,而非趨勢符號。",
        },
        "evidence": [
            "衛星被動微波紀錄顯示北極海冰範圍與體積指標多十年下降,夏末損失尤其大。",
            "IPCC AR6 評估觀測到的北極海冰衰退是近期氣候的穩健特徵,人類影響是多十年趨勢的主因。",
        ],
        "open_questions": [
            "季節性無冰門檻應如何操作定義(面積 vs 持續時間 vs 區域)?",
            "特定極端年中海洋熱與大氣的相對角色為何?",
        ],
    },
    "greenland_ice_sheet_losing_mass": {
        "title": "格陵蘭冰蓋在衛星時代持續損失質量",
        "reasons": {
            "mainstream_model_support":
                "多方法質量收支(IMBIE 等)與 IPCC AR6 把衛星時代格陵蘭質量損失視為穩健。",
            "minor_alternatives_exist":
                "測高、GRACE 與輸入–輸出法的差異造成速率散布,主流綜述中並未反轉多十年損失符號。",
            "overall_direction_robust":
                "衛星時代質量損失方向跨技術穩定;爭論在加速時點與未來分配。",
        },
        "evidence": [
            "IMBIE 調和測高、重力與輸入–輸出法,報告衛星時代格陵蘭冰蓋持續質量損失。",
            "IPCC AR6 評估格陵蘭質量損失是觀測海平面上升的主要貢獻之一,與多方法質量收支一致。",
        ],
        "open_questions": [
            "更高升溫路徑下表面融水與動力輸出如何分配?",
            "世紀至千年尺度的承諾海平面貢獻有多大?",
        ],
    },
    "antarctic_ice_sheet_losing_mass": {
        "title": "南極冰蓋整體在損失質量,或是東南極增益仍抵銷西南極損失",
        "reasons": {
            "two_or_more_mainstream_models":
                "淨損失與時段依賴的抵銷敘事都出現在主流質量收支文獻,尤其圍繞東南極積雪。",
            "no_decisive_evidence_yet":
                "方法與再分析選擇仍足以移動全洲總量,使某些時段的單一結算仍有爭議。",
            "genuine_scientific_camps":
                "這是真實的質量收支辯論(分配與抵銷),不是 AI 發明的爭議。",
        },
        "evidence": [
            "IMBIE 南極綜述報告以西南極與南極半島為主的淨質量損失,東南極部門訊號較小或區域混合。",
            "更新的多方法調和持續精煉部門分配;學界仍爭論特定時段東南極積雪抵銷相對 WAIS/半島損失有多大。",
        ],
        "competing": [
            {"name": "南極淨質量損失(WAIS/半島主導)",
             "for": "IMBIE 類多任務調和顯示全洲淨損失由西南極與半島驅動。",
             "against": "東南極積雪與再分析選擇可在某些時間窗降低或反轉推得的淨損失。",
             "limits": "部門誤差棒仍大;方法選擇仍移動總量。"},
            {"name": "東南極增益可抵銷西部損失(時段依賴)",
             "for": "部分測高與輸入–輸出時段顯示強東南極質量增益。",
             "against": "較晚的多方法評估強調西部動力損失主導多十年收支。",
             "limits": "抵銷對時間窗敏感;不是高升溫下長期穩定的宣稱。"},
        ],
        "open_questions": [
            "調和降雪再分析後,東南極多十年質量趨勢最佳估計為何?",
            "部門不確定性應如何溝通給海平面推估?",
        ],
    },
    "marine_ice_sheet_instability": {
        "title": "海洋冰蓋不穩定已在西南極關鍵部門(如 Thwaites)展開",
        "reasons": {
            "rapidly_growing_literature":
                "Thwaites 與 Amundsen 海部門的觀測與模擬文獻快速增長。",
            "no_consensus_formed_yet":
                "即使觀測到快速退縮,MISI 是否已作為全洲尺度「承諾」仍有爭議。",
            "insufficient_observation":
                "仍需更長時間序列與更好床底/海洋約束,才能關閉不可逆門檻宣稱。",
        },
        "evidence": [
            "以觀測變薄與退縮強迫的冰蓋模式實驗主張 Amundsen 海部分已處不穩定退縮構型。",
            "衛星與航空觀測記錄 Thwaites 與鄰近冰川的快速接地線退縮與動力變薄。",
        ],
        "open_questions": [
            "哪些部門已過不可逆門檻、哪些仍可被床地形穩定?",
            "冰架支撐與融水變率能減緩或調變類 MISI 退縮多少?",
        ],
    },
    "permafrost_carbon_feedback": {
        "title": "融化凍土將在本世紀釋放大型淨溫室氣體回饋",
        "reasons": {
            "rapidly_growing_literature":
                "凍土碳與冬季通量論文快速擴張。",
            "insufficient_observation":
                "冬季與北極內陸通量網稀疏,留下大區域空白。",
            "no_consensus_formed_yet":
                "回饋的量級、時序與溫室氣體組成在模式與觀測放大間仍未定。",
        },
        "evidence": [
            "凍土碳庫與融化過程綜述主張本世紀有可觀碳–氣候回饋,量級與時序不確定性大。",
            "冬季與肩季呼吸的觀測與模式評估凸顯北極凍土區被低估的 CO2 損失。",
        ],
        "open_questions": [
            "不同融化路徑下 CO2 與 CH4 淨分配為何?",
            "政策相關時間尺度上有多少碳庫脆弱、多少是多世紀承諾?",
        ],
    },
    "antarctic_sea_ice_recent_lows": {
        "title": "近年南極海冰低點標誌體制轉移,而非年際噪聲",
        "reasons": {
            "new_discovery":
                "相對更長的北極衰退文獻,近年南極海冰極端是新的觀測焦點。",
            "no_consensus_formed_yet":
                "近年低點是否構成持久體制轉移仍有辯論。",
            "insufficient_observation":
                "衛星時代相對南大洋多十年模態仍短。",
        ...
        "evidence": [
            "衛星紀錄顯示南極海冰年際變率大,包括與北極較平滑多十年衰退性質不同的多年高/低段。",
            "評估文獻把南極海冰趨勢視為區域複雜、不如北極衰退線性,並對近期極端 vs 長期體制變化保持開放。",
        ],
        "open_questions": [
            "2016 年後南極海冰極端是新基線,還是自然變率的尾部?",
            "海洋熱、風與冰架淡水通量如何共同造成近期低點?",
        ],
    },
    "arctic_ice_free_summer_imminent": {
        "title": "在現況下,可靠的北極夏季無冰在幾年內實質上已可確定",
        "reasons": {
            "not_accepted_by_mainstream":
                "主流評估在持續升溫下投影北極夏季無冰,但不把「幾年內實質確定」視為已結案預報。",
            "philosophical_inference":
                "把多十年投影包絡壓成「幾年內實質確定」是超出已錄證據等級的過度解讀。",
        },
        "evidence": [
            "基於過程與觀測約束的分析把累積 CO2 與九月北極海冰損失相連,支持持續升溫下無冰夏的投影——"
            "時序不確定性仍大。",
            "評估文獻在高排放下投影本世紀後期北極夏季無冰,但不把「幾年內實質確定」當封閉結果。",
        ],
        "open_questions": [
            "哪種無冰定義(面積門檻、持續時間)對政策相關?",
            "內部變率還能延後或提前第一個無冰九月多少?",
        ],
    },
}
