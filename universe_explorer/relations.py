...
_AUTHORED: Tuple[Tuple[str, str, str, str], ...] = (
    ...
    # Formerly graph-isolated (honest adjacencies, not densification for show):
    ("cluster_sidm_cross_section_bounds", "sidm_small_scales", "supports",
     "Cluster-merger σ/m bounds are empirical input to the SIDM programme."),
    ("monojet_collider_searches", "thermal_wimp_freezeout_benchmark", "supports",
     "LHC monojet + MET limits cut into the thermal WIMP window."),
    ("dwarf_spheroidal_indirect_limits", "dm_particle_identity", "supports",
     "dSph gamma-ray non-detections constrain annihilation identity channels."),
    ("dwarf_spheroidal_indirect_limits", "fermi_gc_excess_origin", "tensions",
     "dSph limits tension pure-DM readings of the Galactic-centre excess."),
    ...
    ("late_heavy_bombardment", "solar_system_age", "requires",
     "LHB chronology is dated inside the ~4.56 Ga solar-system timeline."),
    ("late_heavy_bombardment", "moon_giant_impact", "requires",
     "A late bombardment spike is framed after the Moon-forming impact."),
    ("mars_sustained_surface_habitability_now", "ocean_world_life_today",
     "boundary",
     "Mars surface habitability now vs extant icy-moon ocean life — different arenas."),
    ...
    ("jwst_exoplanet_atmospheres", "trappist1_inner_planets_airless", "supports",
     "Inner-TRAPPIST airless claims rest on the same JWST atmosphere channel."),
    ("trappist1b_bare_rock", "trappist1_inner_planets_airless", "specializes",
     "TRAPPIST-1 b bare-rock is the best-measured pole under the inner airless claim."),
