...
def validate_provenance(
    ...
    """P1 rules. Returns violations in the same shape as the v0 validator so
    build.py can gate on both lists at once."""
    ...
    for claim in topic.claims:
        for src in claim.sources:
            ...
            if arxiv_id is None:
                continue  # honestly exempt: no fetchable endpoint
